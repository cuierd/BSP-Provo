...
newTrial("instructions",
    ...
    ,
    newText("When you begin, you'll see dashed lines on the screen, with each dash representing a hidden word. Press the SPACEBAR to reveal each word one at a time. Words will appear sequentially as you press the key. Please note, you cannot go back to previous words. Once a word is passed, you won't be able to reread it. Take your time to read and understand each word. There is no time limit for this task.")
    ,
    newText("The first text is a practice run. It will be followed by a comprehension question to test your understanding.")
    ,
...
newTrial("end",
    ...
    newText("<p><a href='https://app.prolific.com/submissions/complete?cc=C1KGX8OM' target='_blank'>Click here to validate your submission</a></p>")
        .center()
        .print()
    ,
